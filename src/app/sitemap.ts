...
const STATIC_PATHS: {
  ...
  { path: "/sponsors", priority: 0.5, changeFreq: "weekly" as const },
  ...
  { path: "/unlock", priority: 0.6, changeFreq: "monthly" as const },
  { path: "/premium", priority: 0.5, changeFreq: "monthly" as const },
